...
from .gateway_views import (
    ...
    # ThreeDSCallbackView  # Disabled - not needed for product import
)
...
urlpatterns = [
    ...
    # path('gateway/threeds-callback/', ThreeDSCallbackView.as_view(), name='threeds-callback'),  # Disabled - not needed for product import
